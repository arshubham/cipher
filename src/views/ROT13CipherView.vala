    ...
    public class ROT13CipherView : Gtk.Grid {
        ...
        public ROT13CipherView () {
            ...
            enchiper_button.clicked.connect (() => {
                ciphertext_textview.buffer.text = rot13.encrypt (plaintext_textview.buffer.text);
            });

            dechiper_button.clicked.connect (() => {
                plaintext_textview.buffer.text = rot13.decrypt (ciphertext_textview.buffer.text);
            });
        }
