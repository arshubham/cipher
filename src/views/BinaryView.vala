...
public class AtbashCipherView : Gtk.Grid  {
    ...
    construct {
        ...
        labelTitle = new Gtk.Label ("Binary");
        ...
        enchiperButton.clicked.connect (() => {
            ...
            cipherText = ""; 
            cipherTextTextView.buffer.text = binary.encryptBinary (plainText);
        });
        ...
        dechiperButton.clicked.connect (() => {
            ...
            plainTextTextView.buffer.text = binary.decryptBinary (cipherText);
        });
    }
